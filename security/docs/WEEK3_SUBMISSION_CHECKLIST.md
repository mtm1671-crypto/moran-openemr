...
- `B2B_PRODUCTION_READINESS.md` and `RULES_OF_ENGAGEMENT_TEMPLATE.md` capture the client-grade control package.
...
- Local checks pass for tests, lint, and type checking: 50 pytest tests, Ruff, and mypy.
