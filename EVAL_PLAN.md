...
Release-ready dataset, automated coverage, and current results are captured in [EVAL_DATASET.md](EVAL_DATASET.md). This file preserves the original eval design and fixture plan.
