...
INSERT INTO af_demo_note_content VALUES
    ...
    ('AF-MVP-002', 1, '2026-04-25 15:05:00', 'LOINC:11506-3', 'Progress Note',
     'AgentForge MVP seed note: Cardiopulmonary follow-up. Subjective: Marcus reports using albuterol two to three times per week and has no resting dyspnea. Exam narrative: trace ankle edema, lungs with scattered expiratory wheeze. Assessment: COPD and diastolic heart failure appear clinically stable today. Plan discussed in visit: reinforce inhaler technique and daily weight log.'),
    ('AF-MVP-002', 2, '2026-04-27 10:15:00', 'LOINC:34746-8', 'Nurse Note',
     'AgentForge MVP seed note: Post-visit outreach. Marcus reports weight unchanged from clinic and no missed apixaban doses. He was reminded to call for increased swelling, new palpitations, or worsening shortness of breath. Transportation for follow-up visit confirmed.'),
    ...
    ('AF-MVP-002', 3, '2026-04-29 17:05:00', 'LOINC:34109-9', 'Patient Message',
     'AgentForge MVP seed note: Portal message from Marcus. He reports shortness of breath after carrying groceries up two flights of stairs but says symptoms settled after resting and using albuterol. Home weights were 204, 205, and 205 pounds over three mornings. He denies chest pressure, hemoptysis, black stools, or missed apixaban. He asks whether pollen could be worsening cough because windows have been open at night.'),
    ('AF-MVP-002', 4, '2026-04-30 09:10:00', 'LOINC:34746-8', 'Care Management Note',
     'AgentForge MVP seed note: Respiratory care coordination. Marcus brought inhalers to clinic by phone video review and demonstrated using the rescue inhaler before full exhalation, then corrected technique after coaching. He has a spacer at home but stores it separately from the inhaler. Pharmacy confirmed apixaban refill was picked up on 2026-04-22. Transportation service was booked for the next cardiology visit.'),
